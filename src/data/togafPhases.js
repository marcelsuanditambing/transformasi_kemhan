...
export const phases = [
    ...
    "subDomains": [
      {
        ...
        "paragraphs": [
          ...
          "Gambar III.5 menunjukkan bahwa arsitektur data merupakan salah satu dari dua cabang fase Information Systems Architecture yang dikerjakan terlebih dahulu. Input, step, dan output yang membentuk arsitektur data disajikan pada Tabel di bawah ini.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Gambar III.7 menempatkan fase Technology Architecture sebelum fase C5ISR architecture . Posisi ini menegaskan perannya sebagai penyedia fondasi teknologi yang menentukan kelayakan penerapan seluruh rancangan sebelumnya. Input, step, dan output disajikan pada Tabel di bawah ini.",
