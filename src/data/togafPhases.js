...
export const phases = [
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Gambar di samping menempatkan fase Business Architecture sebagai fase pertama dari kelompok pengembangan domain arsitektur. Sebagai fase yang menerjemahkan visi menjadi rancangan organisasi yang konkret, Business Architecture menjadi pijakan bagi perancangan arsitektur data, aplikasi, teknologi, dan C5ISR pada fase-fase sesudahnya. Uraian input, step, dan output dapat dilihat pada Tabel di bawah ini.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Gambar di samping menempatkan fase Technology Architecture sebelum fase C5ISR architecture . Posisi ini menegaskan perannya sebagai penyedia fondasi teknologi yang menentukan kelayakan penerapan seluruh rancangan sebelumnya. Input, step, dan output disajikan pada Tabel di bawah ini.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Gambar di samping memperlihatkan penempatan fase C5ISR architecture setelah Technology Architecture dan sebelum Opportunities & Solutions menegaskan bahwa kapabilitas C5ISR dirancang di atas fondasi data, aplikasi, teknologi, dan keamanan yang telah ditetapkan sebelumnya. Input, step, dan output disajikan pada Tabel di bawah ini.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Gambar di samping menunjukkan fase Migration Planning sebagai kelanjutan langsung dari fase Opportunities & Solutions dalam kelompok realisasi. Posisi berurutan ini memperlihatkan peralihan dari penetapan paket pekerjaan menuju penetapan urutan dan waktu pelaksanaannya. Input, step dan output dapat dilihat pada Tabel di bawah ini.",
